...
public class CardboardSwordItemRenderer extends BlockEntityWithoutLevelRenderer
{
    private static final ResourceLocation BASE_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(TakumiMod.MODID, "textures/item/cardboard_sword.png");
    private static final ResourceLocation BASE_TEXTURE_STONE =
            ResourceLocation.fromNamespaceAndPath(TakumiMod.MODID, "textures/item/cardboard_sword_reinforced_stone.png");
    private static final ResourceLocation BASE_TEXTURE_DEEPSLATE =
            ResourceLocation.fromNamespaceAndPath(TakumiMod.MODID, "textures/item/cardboard_sword_reinforced_deepslate.png");
